\documentclass[a4paper,10pt,left=4.5cm,right=3cm,top=1cm,bottom=2cm]{article}
...
\begin{figure}[htb]
 \begin{center}
   \includegraphics[width=1\textwidth]{fachlichesKlassendiagramm}
...
\begin{figure}[htb]
 \begin{center}
   \includegraphics[width=1\textwidth]{activity}
